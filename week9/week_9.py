...
class KMeansClustering:
    ...
    def init_centroids(self, data): #choose n random points as means of n cluster
    ...
    def evaluate(self, data):
        ...
        for cluster in range(len(self.centroids)):
            for point in data:
                J+=np.linalg.norm(point-self.centroids[cluster])

        return J

if __name__ == "__main__":
    X1 = np.array([
        [8.34044009e+00, 1.44064899e+01, 2.28749635e-03, 6.04665145e+00,2.93511782e+00],
    ...
    def test1():
        ...
        #     print(f'Failed E Step Test Case 1')
        #     # print("Exception ",e)
        #     print("oca1",oca1)
        #     print("ca1",ca1)
        model = KMeansClustering(5)
